  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-[#1A1F2C] to-[#2d254b] text-white">
      ...
      <section className="relative h-[80vh] flex items-center justify-center overflow-hidden">
        ...
        <div
          className={`container mx-auto px-4 z-10 transition-all duration-1000 transform ${isVisible ? "translate-y-0 opacity-100" : "translate-y-10 opacity-0"}`}
        >
              ...
              <CardContent className="p-8">
                <div className="grid grid-cols-1 md:grid-cols-3 gap-10">
                  ...
                  <div className="md:col-span-2">
                    <h3 className="text-2xl font-bold mb-4 text-[#E5DEFF]">
                      Кто я такой
                    </h3>
                    ...
                    <div className="grid grid-cols-2 gap-4">
                      <div>
                        <h4 className="text-[#9b87f5] font-semibold mb-2">
                          Образование
                        </h4>
        ...
        <div className="container mx-auto px-4">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 max-w-4xl mx-auto">
            {socialLinks.map((link) => (
              <Card
                key={link.name}
                className="bg-[#2d254b]/50 border border-white/10 hover:bg-[#2d254b]/70 transition-all duration-300 group"
              >
                <CardContent className="p-6 flex flex-col items-center text-center">
                  ...
                  <a
                    ...
                    className="mt-2"
                  >
                    <Button className="bg-[#1A1F2C]/50 hover:bg-[#9b87f5] border border-white/10 transition-all duration-300">
                      Подписаться
                    </Button>
                  </a>
                </CardContent>
      ...
      <footer className="bg-[#1A1F2C] py-8 border-t border-white/10">
        <div className="container mx-auto px-4 text-center">
          <p className="text-gray-400">
            © {new Date().getFullYear()} Имя Фамилия. Все права защищены.
          </p>
        </div>
      </footer>
    </div>
